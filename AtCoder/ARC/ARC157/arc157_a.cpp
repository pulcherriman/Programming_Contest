...
int main() {
	...
	// vi tgt = {0, 0, 0, (int)n-1};
	// do{
	// 	vi tgt2 = tgt;
	// 	do {
	// 		bool exist = mp[tgt2] > 0;
	// 		if(exist ^ solve(n, tgt2[0], tgt2[1], tgt2[2], tgt2[3])){

	// 			out(tgt2);
	// 		}
	// 	}while(next_permutation(all(tgt2)));
	// }while(next_partition(all(tgt), n-1));
