...
For those who are not familiar with the Rust language environment, we have prepared a [pre-compiled binary for Windows](https://img.atcoder.jp/ahc053/Q405bDmv_windows.zip).
...
You can visualize the contents of the output file by pasting it into the [visualizer](https://img.atcoder.jp/ahc053/Q405bDmv.html?lang=en).
...
You can also use a [web visualizer](https://img.atcoder.jp/ahc053/Q405bDmv.html?lang=en) which is more rich in features.
...
Rust言語の環境構築が面倒な方向けに、[Windows用のコンパイル済みバイナリ](https://img.atcoder.jp/ahc053/Q405bDmv_windows.zip)も用意してあります。
...
出力された`out.txt`の中身を[ビジュアライザ](https://img.atcoder.jp/ahc053/Q405bDmv.html?lang=ja)に貼り付けると、ビジュアライズが可能です。
...
より機能が豊富な[ウェブ版のビジュアライザ](https://img.atcoder.jp/ahc053/Q405bDmv.html?lang=ja)も利用可能です。
