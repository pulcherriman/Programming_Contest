...
// ハイパーパラメータ設定（狭い範囲最適化の最良パラメータ - Trial 24）
static const double VERY_LOW_PROB_THRESHOLD = 1.0460790504304567e-06;
static const double NEIGHBOR_WEIGHT = 0.023506040280611193;
static const double CORNER_BONUS_BASE = 0.04369608389013945;
static const double CORNER_BONUS_EXTRA = 0.03690727527166102;
static const double ADJACENT_EMPTY_PENALTY = 0.03986040145077578;
static const int ADJACENT_EMPTY_THRESHOLD = 3;
static const int MAX_CANDIDATES_DEPTH0 = 20;
static const int MAX_CANDIDATES_OTHERS = 8;
static const int MAIN_MAX_CANDIDATES = 9;
static const int DEPTH_THRESHOLD_HIGH = 203;
static const int DEPTH_THRESHOLD_MID = 119;
static const int DEPTH_THRESHOLD_LOW = 14;
static const int MAX_DEPTH_SMALL = 4;
...
vector<pii> strategy_lookahead(const vs& field, int N, int M) {
	...
	Timer localTimer(1900); // 安全マージンを持たせる
