...
int main(){
	...
	int n,m;
	cin>>n>>m;
	n=(n*10+1125)%36000/2250;
	vs s={"N","NNE","NE","ENE","E","ESE","SE","SSE","S","SSW","SW","WSW","W","WNW","NW","NNW","C"};
	vi d={2,15,33,54,79,107,138,171,207,244,284,326,100000};
	rep(i,13){
		if(round(m/6.0)<=d[i]){m=i;break;}
	}
	if(m==0)n=16;
	puta(s[n],m);
	return 0;
