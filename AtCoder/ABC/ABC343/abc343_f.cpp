...
namespace SegTreeUtil {
	...
	struct VAL {
		ll val1, val2;
		ll cnt1, cnt2;
		VAL() : val1(0), val2(0), cnt1(0), cnt2(0) {}
		VAL(ll v1, ll v2, ll c1, ll c2) : val1(v1), val2(v2), cnt1(c1), cnt2(c2) {}
		friend VAL operator+(const VAL&a, const VAL&b) {
			VAL ret;
			if (a.val1 == b.val1) {
				if(a.val2 == b.val2) ret= VAL(a.val1, a.val2, a.cnt1 + b.cnt1, a.cnt2 + b.cnt2);
				else if(a.val2 > b.val2) ret= VAL(a.val1, a.val2, a.cnt1 + b.cnt1, a.cnt2);
				else ret= VAL(a.val1, b.val2, a.cnt1 + b.cnt1, b.cnt2);
			}else
			if(a.val1 > b.val1) {
				if(a.val2 == b.val1) ret= VAL(a.val1, a.val2, a.cnt1, a.cnt2 + b.cnt1);
				else if(a.val2 > b.val1) ret= VAL(a.val1, a.val2, a.cnt1, a.cnt2);
				else ret= VAL(a.val1, b.val1, a.cnt1, b.cnt1);
			}else {
				if(a.val1 == b.val2) ret= VAL(b.val1, b.val2, b.cnt1, b.cnt2 + a.cnt1);
				else if(a.val1 > b.val2) ret= VAL(b.val1, a.val1, b.cnt1, a.cnt1);
				else ret= VAL(b.val1, b.val2, b.cnt1, b.cnt2);
			}
			// out(a,"/",b,"=", ret);
			return ret;
		}
		friend ostream& operator<<(ostream& os, VAL&v) {
			return out(v.val1, v.val2, v.cnt1, v.cnt2);
		}
	};
	...
	struct QUERY {
		...
		static Val id_val() { return Val(); }
		static Op id_op() { return -1; }
		static Val concat_val(const Val& l, const Val& r) { return l + r; }
		static Val operate(const Val& l, const Op& r) {
			if(r==-1) return l;
			return VAL(r, 0, 1, 0);
		}
		static Op concat_op(const Op& l, const Op& r) { return r != id_op() ? r : l; }
...
int main() { /**/
	def(ll,n,q);
	SegmentTree<SegTreeUtil::QUERY> st(n);
	rep(i,n){
		def(ll,a);
		st.update(i, a);
	}
