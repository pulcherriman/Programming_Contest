...
int main() { /**/
	def(ll,x1,y1,z1,x2,y2,z2,x3,y3,z3,x4,y4,z4);
	auto intercect = [&](ll a, ll b, ll c, ll d) {
		return min(b, d) - max(a, c) > 0;
	};
	Yn(intercect(x1, x2, x3, x4) and intercect(y1, y2, y3, y4) and intercect(z1, z2, z3, z4));
}