...
constexpr int h(int a,int b,int c){
	return a*16+b*4+c;
}
...
int main(){
	...
	rep(i,n)rep(j,4)rep(k,4)rep(l,4)rep(m,4){
		if(h(j,k,l)==h(0,2,1) and m==0)continue;
		if(h(j,k,l)==h(0,2,1) and m==1)continue;
		if(h(j,k,l)==h(0,2,1) and m==2)continue;
		if(h(j,k,l)==h(0,2,1) and m==3)continue;
		if(h(j,k,l)==h(0,0,2) and m==1)continue;
		if(h(j,k,l)==h(1,0,2) and m==1)continue;
		if(h(j,k,l)==h(2,0,2) and m==1)continue;
		if(h(j,k,l)==h(3,0,2) and m==1)continue;
		if(h(j,k,l)==h(0,2,0) and m==1)continue;
		if(h(j,k,l)==h(0,2,1) and m==1)continue;
		if(h(j,k,l)==h(0,2,2) and m==1)continue;
		if(h(j,k,l)==h(0,2,3) and m==1)continue;
		if(h(j,k,l)==h(0,0,2) and m==1)continue;
		if(h(j,k,l)==h(0,1,2) and m==1)continue;
		if(h(j,k,l)==h(0,2,2) and m==1)continue;
		if(h(j,k,l)==h(0,3,2) and m==1)continue;
		if(h(j,k,l)==h(0,1,2) and m==0)continue;
		if(h(j,k,l)==h(0,1,2) and m==1)continue;
		if(h(j,k,l)==h(0,1,2) and m==2)continue;
		if(h(j,k,l)==h(0,1,2) and m==3)continue;
		if(h(j,k,l)==h(0,0,1) and m==2)continue;
		if(h(j,k,l)==h(1,0,1) and m==2)continue;
		if(h(j,k,l)==h(2,0,1) and m==2)continue;
		if(h(j,k,l)==h(3,0,1) and m==2)continue;
		if(h(j,k,l)==h(2,0,1) and m==0)continue;
		if(h(j,k,l)==h(2,0,1) and m==1)continue;
		if(h(j,k,l)==h(2,0,1) and m==2)continue;
		if(h(j,k,l)==h(2,0,1) and m==3)continue;
		if(h(j,k,l)==h(0,2,0) and m==1)continue;
		if(h(j,k,l)==h(1,2,0) and m==1)continue;
		if(h(j,k,l)==h(2,2,0) and m==1)continue;
		if(h(j,k,l)==h(3,2,0) and m==1)continue;
		dp[i+1][h(k,l,m)]+=dp[i][h(j,k,l)];
	}
	puta(sum(dp[n]));
	return 0;
}